        ...
        <>
            ...
            <div className='container py-10'>
                ...
                <div className="flex flex-col px-0 md:px-20 lg:px-80 w-full mb-16">
                    <h1 className='text-[#0E467D] dark:text-white text-3xl md:text-4xl font-bold mb-3 text-center'>Got Questions? We&apos;ve Got Answers!</h1>
                    <p className='text-[#374F67] dark:text-gray-300 text-md md:text-lg text-center'>At Captain&apos;s Cafe, we believe in providing clarity and support. Our FAQs are designed to help you navigate our services, understand our mission, and find the answers you need. Join us in creating memorable experiences!</p>
                </div>
                ...
                >
                    ...
                    <AccordionItem value="item-1">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Do you offer a complimentary trial?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="billing-history">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">How do I access my billing history?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="payment-method">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Can I change my payment method at any time?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="late-fees">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Are there any fees for late payments?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="plan-limits">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">What happens if I exceed my plan's limits?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="trial-period">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Is there a trial period before subscribing?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="reset-password">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">How do I reset my password?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="refund-policy">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Can I get a refund for unused services?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="support-options">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">What support options are available with my plan?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="annual-discounts">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Are there discounts for annual subscriptions?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="multiple-devices">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Can I use my subscription on multiple devices?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="privacy">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Is my personal information kept private?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="technical-issue">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">How do I report a technical issue?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="plan-features">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">What features are included in the different plans?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <AccordionItem value="pause-subscription">
                        <AccordionTrigger className="text-md items-center text-amber-900 dark:text-orange-200">Can I pause my subscription temporarily?</AccordionTrigger>
                        <AccordionContent className="flex flex-col gap-4 text-sm text-gray-500 dark:text-gray-300">
