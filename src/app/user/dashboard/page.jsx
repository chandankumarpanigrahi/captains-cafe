    ...
    <div className='flex flex-col space-y-3'>
      <div className="px-6 py-4 rounded-md bg-white dark:bg-neutral-800 shadow-[inset_-4px_-4px_4px_-1px_rgba(0,0,0,0.15)] border border-gray-100 w-full flex flex-row items-center">
        <div className="flex flex-col md:flex-row space-x-3 space-y-2 items-left md:items-center w-full">
          {/* Single Image component that changes */}
          <Image
      ...
      <div className="flex flex-row flex-wrap w-full justify-between">
        <div className="w-full lg:w-[calc(100%-272px)] flex flex-col justify-between">
          ...
          <div className="w-full px-6 py-4 rounded-md bg-sky-50 dark:bg-neutral-800 shadow-[inset_-4px_-4px_4px_-1px_rgba(0,0,0,0.15)] border border-gray-100 flex flex-col items-start">
            <h1 className='text-3xl font-semibold mb-2 text-blue-900'>62</h1>
            <div className="flex flex-row gap-1 items-start text-green-900/80">
              <small className='mt-0.5'><IoArrowUpOutline size={14} /></small>
              <div className='text-[11px]'>12% than Last Month</div>
            </div>
            <p className='text-sm'>Total Orders</p>
        ...
        <div className="w-full lg:w-[260px] px-6 py-4 rounded-md bg-white dark:bg-neutral-800 shadow-[inset_-4px_-4px_4px_-1px_rgba(0,0,0,0.15)] border border-gray-100 flex flex-row items-center">
        </div>
      </div>
