        ...
        <>
            ...
            <div className='container py-10'>
                <div className='flex flex-col gap-2 md:gap-3 items-center mb-5'>
                    <h1 className='text-2xl md:text-4xl mb-1 md:mb-3 text-center font-semibold text-[#0E467D]'>&#10024; Magical Harry Potter Week at The Captain&apos;s Cafe!</h1>
                    <p className='text-center text-sm md:text-[16px] w-full lg:w-9/12 text-[#374F67] mb-5'>Calling all witches, wizards, and muggles! &#127775; From <strong className='text-amber-700'>5th Nov 2025</strong> to <strong className='text-amber-700'>11th Nov 2025</strong>, Captain&apos;s Cafe is transforming into a Hogwarts-inspired haven with spellbinding treats, enchanting decor, and non-stop Harry Potter movie marathons!</p>
                    <h4 className='text-[#0E467D] text-md md:text-xl text-center font-semibold'>🪄 The Magic Awaits You…</h4>
                </div>

                <Image src={banner} alt='Banner' className='w-full rounded-2xl mb-4 hidden md:block' />
                ...
                <div className="flex flex-col lg:flex-row">
                    <div className="w-full lg:w-8/12 mb-6">
                        ...
                        <section className='my-5'>
                            <h6 className='text-[#0E467D] text-lg font-semibold mb-1'>1. Themed Food & Drinks (100% Muggle-Approved!)</h6>
                            ...
                            <i className='text-[#374F67] font-medium'>(Vegetarian & vegan options available! Ask your server for “Muggle modifications.”)</i>
                        </section>

                        <div className={`${styles.blog_hr_line} w-full flex justify-center`}><RiCake3Line size={20} color='#31699E' /></div>

                        <section className='my-5'>
                            <h6 className='text-[#0E467D] text-lg font-semibold mb-1'>2. Daily Movie Screenings</h6>
                            <p className='text-[#0E467D] font-semibold mb-2'>Relive the magic on our big screen!  Schedule:</p>
                            ...
                            <i className='text-[#374F67] font-medium'>(&#128356; Time: 6 PM &minus; 9 PM (Dinner + Movie Specials Available))</i>
                        </section>
                        ...
                        <section className='my-5'>
                            <h6 className='text-[#0E467D] text-lg font-semibold mb-1'>&#127757; “I Solemnly Swear I&apos;m Up for This!”</h6>
