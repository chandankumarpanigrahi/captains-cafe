        ...
        <>
            ...
            <div className='flex flex-col md:flex-row w-full mt-3'>
                <Card className="rounded-md gap-3 p-4 h-fit w-full md:w-[370px] mb-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-2 w-full max-h-[calc(100vh-240px)] overflow-y-auto">
                ...
                <Card className="rounded-md gap-1.5 p-4 w-full h-fit ml-0 md:ml-3">
                    ...
                    <div className="flex flex-row flex-wrap gap-y-2 py-2">
                        <div className="flex flex-col sm:flex-row w-full lg:w-1/2">
                            <h2 className='text-gray-600 block font-medium text-md w-[220px] pb-0.5 sm:pb-0'>Working Hours</h2>
                            <p className='text-gray-500 before:content-[""] sm:before:content-[":"] before:pr-0 sm:before:pr-2 before:pb-1 before:font-bold'>09:00 am - 10:00 pm</p>
                        </div>
                        <div className="flex flex-col sm:flex-row w-full lg:w-1/2">
                            <h2 className='text-gray-600 block font-medium text-md w-[220px] pb-0.5 sm:pb-0'>Mobile Number</h2>
                            <p className='text-gray-500 before:content-[""] sm:before:content-[":"] before:pr-0 sm:before:pr-2 before:pb-1 before:font-bold'>+91 81447 74349</p>
                        </div>
                        <div className="flex flex-col sm:flex-row w-full lg:w-1/2">
                            <h2 className='text-gray-600 block font-medium text-md w-[220px] pb-0.5 sm:pb-0'>Location</h2>
                            <p className='text-gray-500 before:content-[""] sm:before:content-[":"] before:pr-0 sm:before:pr-2 before:pb-1 before:font-bold'>Bhubaneswar, Odisha</p>
                        </div>
                    </div>
                    <hr />
                    <div className="flex flex-col flex-wrap gap-y-2 py-2">
                        <div className="flex flex-col sm:flex-row">
                            <h2 className='text-gray-600 block font-medium text-md w-[220px] pb-0.5 sm:pb-0'>Header</h2>
                            <p className='w-full sm:w-[calc(100%-220px)] text-gray-500 before:content-[""] sm:before:content-[":"] before:pr-0 sm:before:pr-2 before:pb-1 before:font-bold'>The Captain's Café - Sail Into Flavors.</p>
                        </div>
                        <div className="flex flex-col sm:flex-row">
                            <h2 className='text-gray-600 block font-medium text-md w-[220px] pb-0.5 sm:pb-0'>Body</h2>
                            <p className='w-full sm:w-[calc(100%-220px)] text-justify text-gray-500 before:content-[""] sm:before:content-[":"] before:pr-0 sm:before:pr-2 before:pb-1 before:font-bold'>Situated in the vibrant city of Bhubaneswar, Scottish Café is your destination for mouth-watering vegetarian snacks, exceptional catering services, and delightful bakery creations. We take pride in crafting every dish with care, using only the freshest ingredients.
                                Whether it&apos;s a quick snack, a special event, or a sweet indulgence, Scottish Café promises a memorable experience filled with flavor, warmth, and tradition. Join us to savor the best of vegetarian cuisine and baked delights!</p>
                        </div>
                    </div>
                </Card>
            </div>
