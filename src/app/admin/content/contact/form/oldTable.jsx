...
const SubmitTable = () => {
    const [testimonials, setTestimonials] = useState([
        { id: 1, date: "2026-03-10", time: "10:31 AM", name: "Achana Rani Badajena", email: "archana.b23@gmail.com", phone: "7845128956", country: "India", company: "Sulagna Enterprizes", interests: "Bakery", message: "Amazing pastries and friendly service. This cafe has quickly become my go-to place for meetings!", action: "pending" },
        { id: 2, date: "2026-03-10", time: "02:02 PM", name: "Subham Kar", email: "subhamkar223@gmail.com", phone: "8989565623", country: "India", company: "LLP Finances Ltd", interests: "Cafe", message: "The patio seating is a hidden treasure. Sipping their signature coffee while reading a novel is pure bliss!", action: "pending" }
    ]);
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex items-center justify-center gap-2">
                    <span className="max-w-[500px] min-w-[200px] break-words text-gray-600">{row.action}</span>
                </div>
            )
        },
