...
import ArchivedPostsTable from './archivedLoyaltyProgramsTable'
import AllPostsTable from './allLoyaltyProgramsTable'
import ExpiredPostsTable from './expiredLoyaltyProgramsTable'
                ...
                <Card className="rounded-md gap-3 p-4 h-fit w-full">
                    ...
                    <div className={`${activeTab === "tab1" ? "block" : "hidden"} w-full flex flex-col gap-2`}>
                        <div className="flex flex-row items-center w-full">
                            ...
                            <Button text="ADD" className='ml-auto' size='sm' icon={<FiPlusSquare />} radius='sm' iconPosition="left" link="/admin/content/offers/loyalty/addLoyaltyProgram" />
                        </div>
                        <hr className='mb-2' />
                        <AllPostsTable />
                    </div>
