            ...
            <div className="flex flex-col lg:flex-row items-center">
                <div className={`${styles.delight_text} w-full flex flex-col pl-0 pr-0 md:pl-16 md:pr-12`}>
                    ...
                    <div className="flex flex-row justify-center items-center mb-10">
                        <Link href="#" className='text-[#0B3F71]'>View All</Link>
                    </div>

                    <div className="flex flex-col w-full md:w-1/2 lg:w-4/10 items-center mx-auto mb-20">
                        <h2 className='text-[#0B3F71] text-center text-xl mb-4'>Subscribe to learn about new Posts, the latest in Blogs, solutions, and updates.</h2>
                        <div className="flex flex-col gap-2 w-8/10">
                            ...
                            <p className='text-[12px] text-gray-500 text-center md:text-left font-light'>We care about your data in our <Link href="#" className='underline text-blue-600 decoration-blue-400 decoration-1 underline-offset-1'>privacy policy</Link></p>
                        </div>
                    </div>

                    {/* Maps Area */}
                    <h1 className='color-primary text-4xl font-bold mb-8 text-center'>Visit to Our Cafe</h1>
