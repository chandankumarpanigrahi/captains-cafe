    ...
    const menuItems = [
        {
            name: "Snacks",
            image: snacks,
            link: "/menu?tab=cafe&location=saheed&menu=food",
            imageOutline: snacksOutline
        },
        {
            name: "Beverages",
            image: beverages,
            link: "/menu?tab=cafe&location=saheed&menu=beverage",
            imageOutline: beveragesOutline
        },
        {
            name: "Bakery",
            image: bakery,
            link: "/menu?tab=cafe&location=saheed&menu=bakery",
        ...
        <div className={`${styles.background_design} relative bg-white w-full animate__animated animate__fadeInUp mt-18 mb-6 md:mb-18`}>
            <div className='container mx-auto animate__animated animate__fadeInUp'>
                ...
                <div className="flex flex-row flex-wrap w-full">
                    {menuItems.map((item) => (
                        <Link key={item.name} className="w-full sm:w-1/2 lg:w-1/4 px-2 mb-3 lg:mb-0 group" href={item.link}>
